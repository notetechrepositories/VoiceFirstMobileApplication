...
//   Widget build(BuildContext context) {
//     final details = {
//       "Division One Label": country.divisionOneLabel,
//       "Division Two Label": country.divisionTwoLabel,
//       "Division Three Label": country.divisionThreeLabel,
//     };
...
//             .map((entry) => _infoText(entry.key, entry.value))
//             .toList(),
//       ),
//       actions: [
//         TextButton(
...
//     return Padding(
//       padding: const EdgeInsets.only(bottom: 8.0),
//       child: Text('$label: $value', style: TextStyle(color: textPrimary)),
//     );
//   }
// }
